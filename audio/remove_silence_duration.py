"""
SCRIPT TO REMOVE SILENCE IN AN AUDIO FILE AND RETAIN VOICE ACTIVITY

If you just want to remove the silence without VAD
```
import librosa
...
https://github.com/ngbala6/Audio-Processing
...
def main(args):
    if len(args) != 2:
        ...
        sys.exit(1)
    audio, sample_rate = read_pcm16(args[1])
    ...
    write_wave(os.path.basename(args[1]), joinedaudio, sample_rate)
